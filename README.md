...
## Publishing Releases
To publish changes to our internal ACE artifactory repo ensure you have a gradle.properties file in your home directory gradle directory with the following values:
