 ...
 *
 * <p>JNDI DataSources are required for the PooledNexus to operate and generally these are
 * configured inside an application server such as Tomcat. This class creates DataSources using the
 * DBCP pooling library to fill the role of an application server when there isn't one configured.
 *
 * @author slominskir
 */
