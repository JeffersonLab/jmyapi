 ...
 * the database and returns a subset (performs application layer filtering). The
 * intention is to provide a sampling of the original data that maintains
 ...
 * Triangle Three Bucket algorithm presented by Sveinn Steinarsson in his
 * Master's Thesis "Downsampling Time Series for Visual Representation". An
...
public class GraphicalSamplerFloatEventStream extends FloatEventStream {
    ...
    /**
     * Create a new AdvancedSamplerFloatStream. The number of bins may be less
     * than requested if the stream contains an insufficient number of data
     * points.
     *
    ...
    /**
     * Get the next event from the downsampled stream Will return null when stream is
     * exhausted.
     *
