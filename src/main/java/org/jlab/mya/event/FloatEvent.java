...
public class FloatEvent extends Event {
   ...
   * fractional second precision displayed. Note: using a value of 6 (microseconds) is generally the
   * max precision (A precision up to 9, nanoseconds, is supported, but rounding errors prevent
   * proper conversion).
   *
  ...
  public String toString(int f) {
    ...
    return this.getTimestampAsInstant()
