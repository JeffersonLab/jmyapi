 ...
 * (N_QUERIES). Different constructors create streams that use either of these two strategy  Previous versions attempted
 * a hybrid approach, but that did not work well since processing a ResultSet cannot be cleanly cancelled partway
 * through.
 * <p>
 ...
 * the requested sample rate, making multiple queries to the database is obviously better.  Users should be aware of
 * these trade-offs and select the strategy they think best.  Developer testing indicates the threshold for switching
 * strategies to maintain the best response time is somewhere around 5,000 events per sample.
 * <p>
